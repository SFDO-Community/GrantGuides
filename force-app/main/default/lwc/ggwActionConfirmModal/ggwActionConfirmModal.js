...
/**
 * This Modal component is using https://github.com/jamessimone/lwc-modal
 * and also this example https://github.com/fromsteinsfdc/lwc-modal
 */
export default class GgwActionConfirmModal extends LightningElement {
	@api
	message;
	@api
	recordId;
